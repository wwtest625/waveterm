...
declare global {
    ...
    // wps.WaveEvent
    type WaveEventName = "blockclose" | "connchange" | "sysinfo" | "controllerstatus" | "builderstatus" | "builderoutput" | "waveobj:update" | "blockfile" | "config" | "userinput" | "route:down" | "route:up" | "workspace:update" | "waveai:ratelimit" | "waveapp:appgoupdated" | "waveai:modeconfig" | "tab:indicator" | "block:jobstatus" | "waveai:bgjob";
    ...
    type WaveEvent = {
        ...
        { event: "waveai:bgjob"; data?: UIChatBackgroundJobInfo; }
    );
