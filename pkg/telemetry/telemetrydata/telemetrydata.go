...
var ValidEventNames = map[string]bool{
	...
	"waveai:perf:submit":           true,
	"waveai:perf:firsttoken":       true,
	"waveai:perf:done":             true,
	"waveai:perf:approvalwait":     true,
	"waveai:perf:tool:start":       true,
	"waveai:perf:tool:done":        true,
	"waveai:perf:tool:interaction": true,
	"waveai:perf:retry":            true,
